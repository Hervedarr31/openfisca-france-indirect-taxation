...
def merge_indiv_teg_menage():
    ...
    data_teg['duree_trajet_aller_retour_teg'] = data_teg.duree_trajet_aller_teg + data_teg.duree_trajet_retour_teg
    data_teg['distance_routiere_hebdomadaire_par_teg'] = (
        data_teg.distance_routiere_teg
        * data_teg.nb_aller_retour_jour_teg
        * data_teg.nb_jours_deplacement_teg
        )

    data_teg['distance_routiere_hebdomadaire_teg'] = (data_teg
        .groupby(['ident_men'])['distance_routiere_hebdomadaire_par_teg']
        .transform('sum')
        )
    data_teg['duree_moyenne_trajet_aller_retour_teg'] = (data_teg
        .groupby(['ident_men'])['duree_trajet_aller_retour_teg']
        .transform('sum')
        )
